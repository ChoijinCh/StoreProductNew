"""
Django settings for drf_table_ex project.
...
SECRET_KEY = '-q42br3whr$+$ck*yd91+8le^8r^brnp!%c&q6(w+df0*4lbgp'
...
ROOT_URLCONF = 'ProductRecord.urls'
...
WSGI_APPLICATION = 'ProductRecord.wsgi.application'
